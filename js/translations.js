...
const translations = {
    en: {
        ...
        'about.role.marketingcoordinator': 'Marketing Coordinator',
        'about.role.design': 'Design Director',
        ...
        'about.role.socialmedia': 'Social Media Coordinator',
        ...
        'about.nea.desc': '2nd year International Business student committed to coordinating CERNO’s social media presence.',
        'about.lifei.quote': '"天将降大任于斯人也/When Heaven is about to confer a great responsibility on this man" - 孟子Mengzi',
        'about.nea.quote': '“Nothing can cure the soul but the senses, just as nothing can cure the senses but the soul.” - Oscar Wilde',        'about.bahar.desc': 'First-year Business Information Technology student passionate about digital marketing and business development. Member of CERNO\'s marketing team, actively involved in digital marketing initiatives and collaborative projects.',
        'about.bahar.quote': '"The only way to do great work is to love what you do." - Steve Jobs',        'about.ronja.quote': '"Coming together is a beginning; keeping together is progress; working together is success." - Henry Ford',
        ...
        'events.caseeve.pastdesc': 'Thank you to everyone who joined our first Case Club Night on April 1st! Participants presented their own business solutions, evaluated by a judging panel. It was an excellent evening of soft skills development, presentation confidence, and business problem-solving.',
        'events.infoevening.pastdesc': 'On March 17th, FC Lahti presented a real business challenge and shared a practical solution approach. The session strengthened participants\' business knowledge and communication skills by connecting theory with real-world decision-making.',
        'events.citylahti.info.title': 'City of Lahti - Info',
        'events.citylahti.info.desc': 'On April 23rd, the City of Lahti will present a real business challenge and share a practical solution approach. This session is designed to strengthen participants\' business knowledge and communication skills by connecting theory with real-world decision-making.',
        'events.citylahti.info.pastdesc': 'On April 23rd, the City of Lahti presented a real business challenge and shared a practical solution approach. The session strengthened participants\' business knowledge and communication skills by connecting theory with real-world decision-making.',
        'events.citylahti.presentations.title': 'City of Lahti - Presentations',
        'events.citylahti.presentations.desc': 'On May 5th, teams will present their solutions to the City of Lahti business challenge. A judging panel will evaluate each presentation, making this an excellent opportunity to improve soft skills, presentation confidence, and business problem-solving.',
        'events.citylahti.presentations.pastdesc': 'On May 5th, teams presented their solutions to the City of Lahti business challenge. A judging panel evaluated each presentation, giving participants an excellent opportunity to improve soft skills, presentation confidence, and business problem-solving.',
        'events.noupcoming': 'No upcoming events at the moment. Check back soon!',
        ...
        'resources.ncc2026.desc': 'Read about LAB UAS\'s journey at the Nordic Case Competition 2026. Discover the team\'s experience, challenges faced, lessons learned, and highlights from this year\'s prestigious Nordic case event.',
        ...
        'resources.cerno.en.title': 'Cerno - English (Cyan)',
        ...
        'about.role.marketingcoordinator': 'Markkinointikoordinaattori',
        'about.role.design': 'Muotoilujohtaja',
        ...
        'about.role.socialmedia': 'Sosiaalisen median koordinaattori',
        ...
        'about.nea.desc': 'Toisen vuoden kansainvälisen liiketalouden opiskelija, joka on sitoutunut koordinoimaan CERNOn sosiaalisen median näkyvyyttä.',
        'about.lifei.quote': '"天将降大任于斯人也/Kun Taivas on antamassa tälle ihmiselle suuren vastuun" - 孟子Mengzi',
        'about.nea.quote': '“Mikään ei voi parantaa sielua paitsi aistit, aivan kuten mikään ei voi parantaa aisteja paitsi sielu.” - Oscar Wilde',        'about.bahar.desc': 'Ensimmäisen vuoden tietojenkäsittelyn opiskelija, joka on intohimoinen digitaaliseen markkinointiin ja liiketoiminnan kehittämiseen. CERNOn markkinointitiimin jäsen, aktiivisesti mukana digitaalisen markkinoinnin hankkeissa ja yhteisprojekteissa.',
        'about.bahar.quote': '"Ainoa tapa tehdä loistavaa työtä on rakastaa sitä, mitä teet." - Steve Jobs',        'about.ronja.quote': '"Yhdessä tuleminen on alku; yhdessä pysyminen on edistystä; yhdessä työskentely on menestystä." - Henry Ford',
        ...
        'events.caseeve.desc': 'Myös 1. huhtikuuta järjestettävä ensimmäinen Case Club Night (Case-ilta) kokoaa osallistujat esittelemään omat liiketoimintaratkaisunsa. Tuomaripaneeli arvioi esitykset, joten ilta on erinomainen mahdollisuus kehittää pehmeitä taitoja, esiintymisvarmuutta ja liiketoiminta-analyysiä.',        'events.caseeve.pastdesc': 'Kiitos kaikille, jotka osallistuivat ensimmäiseen Case Club Night -iltaamme 1. huhtikuuta! Osallistujat esittelivät omat liiketoimintaratkaisunsa, jotka tuomaripaneeli arvioi. Ilta oli erinomainen tilaisuus kehittää pehmeäitä taitoja, esiintymisvarmuutta ja liiketoiminta-analyysiä.',
        'events.infoevening.pastdesc': '17. maaliskuuta FC Lahti esitteli todellisen liiketoimintahaasteen ja käytännön ratkaisumallin. Tapahtuma vahvisti osallistujien liiketoimintaosaamista sekä viestintätaitoja yhdistämällä teoriaa ja käytännön päätöksentekoa.',
        'events.citylahti.info.title': 'Lahden kaupunki - Info',
        'events.citylahti.info.desc': '23. huhtikuuta Lahden kaupunki esittelee todellisen liiketoimintahaasteen ja käytännön ratkaisumallin. Tapahtuma vahvistaa osallistujien liiketoimintaosaamista sekä viestintätaitoja yhdistämällä teoriaa ja käytännön päätöksentekoa.',
        'events.citylahti.info.pastdesc': '23. huhtikuuta Lahden kaupunki esitteli todellisen liiketoimintahaasteen ja käytännön ratkaisumallin. Tapahtuma vahvisti osallistujien liiketoimintaosaamista sekä viestintätaitoja yhdistämällä teoriaa ja käytännön päätöksentekoa.',
        'events.citylahti.presentations.title': 'Lahden kaupunki - Esitykset',
        'events.citylahti.presentations.desc': '5. toukokuuta tiimit esittelevät ratkaisunsa Lahden kaupungin liiketoimintahaasteeseen. Tuomaripaneeli arvioi esitykset, joten tilaisuus on erinomainen mahdollisuus kehittää pehmeäitä taitoja, esiintymisvarmuutta ja liiketoiminta-analyysiä.',
        'events.citylahti.presentations.pastdesc': '5. toukokuuta tiimit esittelivät ratkaisunsa Lahden kaupungin liiketoimintahaasteeseen. Tuomaripaneeli arvioi esitykset, ja osallistujat saivat erinomaisen mahdollisuuden kehittää pehmeäitä taitoja, esiintymisvarmuutta ja liiketoiminta-analyysiä.',
        'events.noupcoming': 'Ei tulevia tapahtumia tällä hetkellä. Tarkista myöhemmin uudelleen!',
        ...
        'resources.ncc2026.desc': 'Lue LAB UAS:n matkasta Nordic Case Competition 2026 -kilpailussa. Tutustu tiimin kokemuksiin, kohdattuihin haasteisiin, opittuihin asioihin ja tämän vuoden arvostetun pohjoismaisen case-tapahtuman kohokohtiin.',
        ...
        'resources.cerno.en.title': 'Cerno - Englanti (Syaani)',
