...
const translations = {
    en: {
        ...
        'events.infoevening.desc': 'Join us for an informative evening about CERNO activities and opportunities. Learn more about our upcoming events, membership benefits, and how to get involved in case competitions.',
        'events.caseeve.title': 'Case Eve',
        'events.caseeve.desc': 'An evening dedicated to case solving and networking. Practice your analytical skills, meet fellow case enthusiasts, and prepare for upcoming competitions.',
        ...
        'events.infoevening.desc': 'Liity mukaan informatiiviseen iltaan CERNOn toiminnasta ja mahdollisuuksista. Opi lisää tulevista tapahtumistamme, jäseneduista ja siitä, miten voit osallistua case-kilpailuihin.',
        'events.caseeve.title': 'Case-ilta',
        'events.caseeve.desc': 'Ilta, joka on omistettu casen ratkaisulle ja verkostoitumiselle. Harjoittele analyyttisiä taitojasi, tapaa muita case-harrastajia ja valmistaudu tuleviin kilpailuihin.',
